...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		Object[] colDocktor = new Object[2];
		colDocktor[0] = "ID";
		colDocktor[1] = "Ad Soyad";
		doctorModel.setColumnIdentifiers(colDocktor);
		...
		w_scrollDoctorList.setBounds(10, 30, 280, 316);
		...
		lblNewLabel_1.setBounds(10, 11, 88, 18);
		...
		lblNewLabel_1_4.setBounds(299, 11, 99, 21);
		...
		lblNewLabel_1_4_1.setBounds(300, 102, 99, 21);
		...
		btn_selectDoctor.setBounds(300, 134, 150, 35);
		...
		lblNewLabel_1_1.setBounds(460, 11, 239, 18);
		w_appointment.add(lblNewLabel_1_1);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(460, 30, 239, 316);
		...
		lblNewLabel_1_4_1_1.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 14));
		lblNewLabel_1_4_1_1.setBounds(300, 235, 99, 21);
		w_appointment.add(lblNewLabel_1_4_1_1);
		
		JButton btn_addAppointment = new JButton("Seç");
		...
		btn_addAppointment.setBounds(300, 267, 150, 35);
		...
		w_scrollAppoint.setBounds(10, 11, 689, 335);
	...
	public void updateWhourModel(int doctor_id) throws SQLException {
	    ...
	    // Whour (Saat) listesini çekmemiz lazım, Clinic listesini değil.
